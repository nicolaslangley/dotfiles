...
alias qmake-ios="~/Development/Qt5.7.0/5.7/ios/bin/qmake"
alias qmake-qml-app="~/Development/Qt5.7.0/5.7/ios/bin/qmake ~/Development/Quartz/runtimecore/test/runtimecore_test_qml/runtimecore_test_qml.pro -r -spec macx-ios-clang CONFIG+=iphoneos CONFIG+=qml_debug"
